...
[y_hollow_0,fs_hollow] = audioread("hollow_IMG_4876.wav",[10000,10000+16384]);
...
[y_solid_0,fs_solid] = audioread("Solid_IMG_4876.wav",[55000,55000+16384]);
y_solid = y_solid_0(:,1);
...
title("Sound wave of hollow sound, one punch")
subplot(2,1,2)
